...
RegisterNetEvent('qb-vehmenu:client:openMenu')
AddEventHandler('qb-vehmenu:client:openMenu', function()
    ...
    local args = tonumber(args)
        if IsPedInAnyVehicle(PlayerPedId(), true) then
            if args == 1 then
                ...
                TriggerEvent('qb-vehmenu:client:windowsMenu')
        end
end)
        ...
        if veh == GetVehiclePedIsIn(PlayerPedId(), true) then
            if IsSeatFree then
                ...
                if args == 1 then
                    ...
                    TriggerEvent('qb-vehmenu:client:seatsMenu')
                end
    ...
    if IsSeatFree == false then
        if GetPedInVehicleSeat(veh, -1) then
            if args == 1 then
                ...
                TriggerEvent('qb-vehmenu:client:engineMenu')
            end
    else
        ...
        if veh == GetVehiclePedIsIn(PlayerPedId(), true) then
            if IsSeatFree then
                ...
                if args == 1 then
                    ...
                    TriggerEvent('qb-vehmenu:client:doorMenu')
                end
            else
...
RegisterNetEvent('qb-vehiclemenu:neoncontrol', function()
    ...
    if not hasNeons then
        ...
        TriggerEvent('qb-vehmenu:client:ccMenu')
        return
    end
        ...
        if veh == GetVehiclePedIsIn(PlayerPedId(), true) then
            if livery then
                ...
                if args == 1 then
                    ...
                    TriggerEvent('qb-vehmenu:client:liveryMenu')
                end
            else
...
-----Turbo Check
RegisterNetEvent('qb-vehmenu:client:turbo', function()
...
RegisterNetEvent('qb-vehmenu:client:ccMenu', function()
...
RegisterNetEvent('qb-vehmenu:client:seatsMenu', function()
...
RegisterNetEvent('qb-vehmenu:client:windowsMenu', function()
    local veh = GetVehiclePedIsIn(PlayerPedId())
...
RegisterNetEvent('qb-vehmenu:client:engineMenu', function()
    createEngineMenu()
    exports['qb-menu']:openMenu(engineMenu)
end)

RegisterNetEvent('qb-vehmenu:client:doorMenu', function()
    local veh = GetVehiclePedIsIn(PlayerPedId())
...
RegisterNetEvent('qb-vehmenu:client:neonMenu', function()
    createNeonMenu()
    exports['qb-menu']:openMenu(neonMenu)
end)

RegisterNetEvent('qb-vehmenu:client:liveryMenu', function()
    if PlayerData.job.name == "police" or PlayerData.job.name == "ambulance" or PlayerData.job.name == "firedept" or PlayerData.job.name == "mechanic" then
        createLiveryMenu()
...
function createCarControlMenu()
    ccMenu = {
        ...
        },
        {
			...
			params = {
                isServer = false,
                event = "qb-vehmenu:client:seatsMenu",
            }
        },
        {
            header = "Windows",
			...
			params = {
                isServer = false,
                event = "qb-vehmenu:client:windowsMenu",
            }
        },
        {
            header = "Engine",
			...
			params = {
                isServer = false,
                event = "qb-vehmenu:client:engineMenu",
            }
        },
        {
            header = "Door Menu",
			...
			params = {
                isServer = false,
                event = "qb-vehmenu:client:doorMenu",
            }
        },
        {
            header = "Neon Menu",
			...
			params = {
                isServer = false,
                event = "qb-vehmenu:client:neonMenu",
            }
        },
        {
            header = "Livery",
			...
			params = {
                isServer = false,
                event = "qb-vehmenu:client:liveryMenu",
            }
        },
        {
            header = "Turbo-Check",
...
function createWindowsMenu()
    windowsMenu = {
        ...
        },
        {
            ...
            params = {
                isServer = false,
                event = 'qb-vehmenu:client:openMenu',
            }
        },
    }
    exports['qb-menu']:openMenu(windowsMenu)
